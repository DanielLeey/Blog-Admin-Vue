  ...
  <div class="app-container">
    ...
    <div v-permission="'/blog/getList'" class="filter-container" style="margin: 10px 0 10px 0;">
      ...
      <el-row :gutter="10" style="margin-bottom: 8px;">
        ...
        <el-col :span="1.5">
          <el-button v-permission="'/blog/uploadLocalBlog'" class="filter-item" type="warning" icon="el-icon-star-on" @click="handleUpload">本地上传</el-button>
        </el-col>

        <el-col :span="1.5">
          <el-button v-permission="'/blog/downloadBatch'" class="filter-item" type="warning" icon="el-icon-s-flag" @click="handleDownload">导出选中</el-button>
        </el-col>

        <el-col :span="1.5">
          <el-button v-permission="'/blog/downloadBatch'" class="filter-item" type="info" icon="el-icon-folder-opened" @click="handleSubject">添加专题</el-button>
        </el-col>
    ...
    <el-table
      ...
      <el-table-column :sort-by="['openComment']" label="开启评论" width="100" align="center" prop="openComment" sortable="custom">
        <template slot-scope="scope">
          <template>
            <el-tag v-for="item in openDictList" v-if="scope.row.openComment === item.dictValue" :key="item.uid" :type="item.listClass">{{ item.dictLabel }}</el-tag>
          </template>
        </template>
      </el-table-column>
    ...
    >
      <el-form ref="form" :model="form" :rules="rules">
        ...
        <el-form-item :label-width="formLabelWidth" label="内容" prop="content">
          <CKEditor ref="editor" :content="form.content" :height="360" @contentChange="contentChange"/>

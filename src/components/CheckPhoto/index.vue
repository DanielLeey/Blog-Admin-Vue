<template>
  <div id="body-loading" class="app-container calendar-list-container">
    <el-dialog :visible.sync="dialogVisible" :before-close="before_close" title="请选择图片" fullscreen>
      <div class="filter-container" style="margin: 10px 0 10px 0;">
        ...
        <el-button class="filter-item" type="primary" icon="el-icon-refresh" @click="handleRest">重置</el-button>
      </div>
      ...
      >
        ...
        >
          ...
          <div v-if="pictureSort.total - (pictureSort.pageSize*pictureSort.currentPage) < 0" class="addPicture" @click="toPictureManager(pictureSort.pictureSortUid)">
            <span>+</span>
          </div>
      ...
      <span slot="footer" class="dialog-footer">
        <div v-for="(picture, index) in form.photoList" :key="index" class="ChooseBody">
          <i v-show="icon" class="el-icon-error inputClass" @click="deletePhoto(index)"/>
